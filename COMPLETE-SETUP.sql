-- ============================================
-- RESILIENT MIND - COMPLETE DATABASE SETUP
-- Copy and paste this ENTIRE file into Supabase SQL Editor
-- Then click RUN
-- ============================================

-- Clean up if tables exist (optional - comment out if first time)
...
-- Create enums
CREATE TYPE IF NOT EXISTS public.membership_type AS ENUM ('free', 'basic', 'premium');
...
-- Insert sample video categories (12 months program in English)
...
-- Setup test account roles and memberships
-- Admin account (2131fb85-2685-4ee2-acae-8d9e577357bb)
