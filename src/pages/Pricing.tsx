...
const MEMBERSHIP_TIERS = [
  ...
  },
  {
    ...
    savings: "Save €94",
    badge: "Most Popular",
    description: "Full 12-month program access with Additional Hubs",
    features: [
      "48 core videos + 48 workbooks + meditations",
      "Additional Hubs: The Transformed Self",
      "Additional Hubs: Navigating Expat Life with Chronic Pain",
      "Bonus: 1-hour free Individual session",
    ],
    buttonText: "Save with Yearly",
    highlighted: true,
  },
